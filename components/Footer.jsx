    ...
    return (
        <footer className="bg-gray-900 text-white py-8">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
                {/* Company Info */}
                <div>
                    <h2 className="text-xl font-semibold">AI Investment Manager</h2>
                    <p className="mt-2 text-gray-400``">Your intelligent partner in managing investments efficiently.</p>
                </div>
                ...
                >
                    ...
                    <p className="mt-2 text-gray-400">Email: support@aiinvestmentmanager.com</p>
                    <p className="text-gray-400">Phone: +1 234 567 890</p>
                    <div className="mt-4 flex space-x-4"></div>
                </div>
            </div>
            <div className="text-center mt-6 border-t border-gray-700 pt-4 text-gray-400">
                &copy; 2025 AI Investment Manager. All rights reserved.
            </div>
        </footer>
    );
}
